...
const Eligible = () => {
    return (
        <div className='sm:py-[55px] py-[50px]'>
            <div className='container mx-auto sm:px-3 px-[25px]'>
                <div className='flex flex-col items-center justify-center' data-aos="fade-down">
                    ...
                    <p className='ff_abril_bold font-semibold text-[30px] sm:text-[39.42px] text-[#0E1122] lg:max-w-[438px] leading-[150%] text-center mb-[20px]'>Who’s eligible for getting our AI funding?</p>
                ...
                <div className='flex flex-row flex-wrap justify-between pt-[30px] sm:pt-[40px] md:pt-[65px]'>
                    <div className='lg:w-[23%] sm:w-[49%] w-full pt-[24px] md:pt-0' data-aos="zoom-in">
                    ...
                    <div className='lg:w-[19%] sm:w-[49%] w-full pt-[24px] md:pt-[30px] lg:pt-0' data-aos="zoom-in">
                        <div className='px-[22px] py-[40px] cursor-pointer hover:shadow-[0px_-5px_10px_0px_rgba(0,0,0,0.2)] transition-all ease-linear duration-300 '>
                            <Annual />
