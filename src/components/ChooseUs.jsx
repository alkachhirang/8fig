    ...
    return (
        <div className='bg-[#0E1122]'>
            <div className='container mx-auto sm:px-3 px-[25px]'>
                <div className='pt-[50px]  sm:pt-[60px] md:pb-[26px]' data-aos="fade-down">
                ...
                <div className='flex flex-row flex-wrap xl:pt-[80px] pt-[40px] pb-[50px] md:py-[65px] xl:pb-[110px] lg:justify-between'>
                    <div className='lg:w-[13%] sm:w-[48%] w-full' data-aos="zoom-in">
                    ...
                    <div className='lg:w-[15%] sm:w-[48%] w-full pt-[50px] sm:pt-0' data-aos="zoom-in">
                        <div className='flex items-center justify-center flex-col'>
                    ...
                    <div className='lg:w-[20%] sm:w-[48%] w-full pt-[50px] lg:pt-0' data-aos="zoom-in">
                        <div className='flex items-center justify-center flex-col'>
                    ...
                    <div className='lg:w-[15%] sm:w-[48%] w-full pt-[50px] lg:pt-0' data-aos="zoom-in">
                        <div className='flex items-center justify-center flex-col'>
