...
const Evalution = () => {
  return (
    <div className='bg-[#efece6] py-[50px] sm:py-[70px] md:py-[120px]'>
      <div className='container mx-auto sm:px-3 px-[25px] xl:max-w-[1132px] xl:pb-[15px]'>
        <div className='flex flex-row items-center flex-wrap justify-between'>
          <div className='lg:w-[44%] w-full' data-aos="fade-right" >
          ...
          <div className='lg:w-[48%] w-full pt-[30px] sm:pt-[40px] lg:pt-0' data-aos="fade-left" >
            <Onesvg />
        ...
        <div className='flex lg:flex-row items-center flex-col-reverse flex-wrap justify-between pt-[50px] sm:pt-[80px] lg:pt-[180px]'>
          <div className='lg:w-[48%] w-full pt-[30px] sm:pt-[40px] lg:pt-0' data-aos="fade-right">
